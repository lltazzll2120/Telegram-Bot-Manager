# Changelog
Le format est basé sur [Keep a Changelog](http://keepachangelog.com/) et ce projet adhère à [Semantic Versioning](http://semver.org/).

Symboles d’exclamation (:exclamation:) notez quelque chose d’important, par exemple des changements de rupture. Cliquez dessus pour en savoir plus.
...
[GITHUB]: https://github.com/lltazzll2120 

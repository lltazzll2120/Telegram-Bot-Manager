...
use Exception;
use Tazz\IPTools\Ip;
use Tazz\TelegramBot\Entities\CallbackQuery;
use Tazz\TelegramBot\Entities\ChosenInlineResult;
use Tazz\TelegramBot\Entities\InlineQuery;
use Tazz\TelegramBot\Entities\Message;
use Tazz\TelegramBot\Entities\ServerResponse;
use Tazz\TelegramBot\Entities\Update;
use Tazz\TelegramBot\Exception\TelegramException;
use Tazz\TelegramBot\Request;
use Tazz\TelegramBot\Telegram;
...
class BotManager
{
    ...
    {
        // Rappelez-vous la fois où nous avons commencé cette boucle.
        $now = time();
    ...
    public function handleGetUpdates(): static
    {
        ...
        // Vérifiez si l’utilisateur a défini un rappel personnalisé pour gérer la réponse.
    ...
    {
        // Si nous exécutons à partir de l’interface de ligne de commande, les demandes sont toujours valides, sauf si nous exécutons les tests.
